...
var browser_alert = function(){
    ...
    /*
    if(BrowserDetect.browser=="Safari" || (BrowserDetect.browser=='Explorer' && BrowserDetect.version >= 6.0)){
        var main_body = document.getElementById("main_body");
        var firefox = document.createElement("div");
        firefox.className = "firefox";
        firefox.innerHTML = "<em>This site is optimized for <a href='http://www.mozilla.com/en-US/firefox/'>Firefox</a> - the faster, better, more secure browser</em>";
        main_body.insertBefore(firefox, main_body.firstChild);
     }
     */
}

window.onload = browser_alert;
