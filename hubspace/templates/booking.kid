...
<div xmlns:py="http://purl.org/kid/ns#" py:strip="True">
   <div py:def="load_booking(date=datetime.now(), view=0, location=None, resgroup=None, room_selected=None, rooms_displayed=None, only_my_bookings=0)">
       <?python
...
?>
   ...
   <c py:if="resgroup" py:strip="True">
    ...
    ?>
    ${load_booking(date='date' in locals() and date or now(loc), 
