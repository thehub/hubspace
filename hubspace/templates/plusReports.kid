...
<div id="managementdataContent" class="pane" xmlns:py="http://purl.org/kid/ns#" py:strip="True" py:layout="'plusMaster.kid'">
    <script py:def="include_js()" src="/static/javascript/plus_reports.js"></script>
