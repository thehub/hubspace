...
?>
<div id="resourcesContent" py:strip="True" xmlns:py="http://purl.org/kid/ns#" py:layout="'plusMaster.kid'">
  <script py:def="include_js()" src="/static/javascript/plus_resources.js"></script>
  <div id="resourcesContent" class="pane"  py:def="load_content(location)">	
